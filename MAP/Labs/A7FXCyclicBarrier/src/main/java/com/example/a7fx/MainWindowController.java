...
public class MainWindowController implements Initializable {
    ...
    private void loadData(){
        ...
        if(selectedProgram != null){
            ...
            InterfaceBarrierTable barrierTable = selectedProgram.getBarrierTable();
            List<Map.Entry<Integer, Pair<Integer, List<Integer>>>> barrierList = new ArrayList<>();

            for (Map.Entry<Integer, Pair<Integer, List<Integer>>> entry : barrierTable.getBarrierTable().entrySet())
