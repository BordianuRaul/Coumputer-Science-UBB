...
public class Interpreter {
    ...
    private void runExample(InterfaceStatement example) {
        ...
        InterfaceBarrierTable barrierTable = new MyBarrierTable();

        ProgramState program = new ProgramState(exeStack, symTable, output, example, fileTable, heap, barrierTable);
