...
public class ProgramState {
    ...
    public ProgramState oneStep() throws MyException, IOException {
        ...
        if(executionStack.isEmpty()) throw new MyException("Program state stack is empty\n.");
    ...
    public void setBarrierTable(InterfaceBarrierTable newBarrierTable) {
