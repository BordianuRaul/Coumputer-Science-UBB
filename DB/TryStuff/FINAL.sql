...
--a. 2 queries with the union operation; use UNION [ALL] and OR;
	...
	--data analyst for a travel agency, and you need to find airports that meet specific criteria to offer the best options to your clients.
...
-- A Query to retrieve all airports and their respective airlines
...
--C.2 queries with the intersection operation; use INTERSECT and IN;
