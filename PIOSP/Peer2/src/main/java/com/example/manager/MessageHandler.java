...
public class MessageHandler {
    ...
    public void handleConsoleInput( CustomReader reader ) throws InterruptedException {
        while ( true ) {
            ...
            try {
                //System.out.println( "urmeaza sa intre in processMessage" );
    ...
    private void processHelloMessage( String receiver ) throws InterruptedException {
        try {
            ...
            if ( connectionStatus ) {
                ...
                if ( ackMessage.equals( ACK ) ) {
                    ...
                    System.out.println( "numarul de conexiuni: " + user.getNumberOfConnections( ) );
            ...
            System.out.println( "Error processing !hello message: " + e.getMessage( ) );
            exec.shutdown( );
        }
    }
}
